...
export function TaskForm({ onSubmit, onCancel, users, initialData }: TaskFormProps) {
  ...
  const [date, setDate] = useState<Date | undefined>(initialData?.dueDate ? new Date(initialData.dueDate) : new Date())
